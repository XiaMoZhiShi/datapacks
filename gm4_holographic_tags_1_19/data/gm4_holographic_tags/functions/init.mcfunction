...
execute unless score holographic_tags gm4_modules matches 19002 run data modify storage gm4:log queue append value {type:"install",module:"Holographic Tags"}
scoreboard players set holographic_tags gm4_modules 19002
