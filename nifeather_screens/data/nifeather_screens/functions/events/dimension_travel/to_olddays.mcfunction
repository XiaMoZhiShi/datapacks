...
execute if predicate nifeather:is_day run title @s subtitle {"translate": "%1$s%3427655$s", "with": ["", [{"text": "Overworld","font": "minecraft:illageralt", "color": "#333333"}]]}
execute if predicate nifeather:weather/thunder run title @s subtitle {"translate": "%1$s%3427655$s", "with": ["", [{"text": "Overworld","font": "minecraft:illageralt", "color": "#ffffff"}]]}
execute if predicate nifeather:is_night run title @s subtitle {"translate": "%1$s%3427655$s", "with": ["", [{"text": "Overworld","font": "minecraft:illageralt", "color": "#ffffff"}]]}
