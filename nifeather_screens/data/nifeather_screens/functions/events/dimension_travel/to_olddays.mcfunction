...
execute unless entity @s[tag=screen_died] if predicate nifeather:is_day run title @s subtitle {"translate": "%1$s%3$s", "with": ["", [{"text": "Overworld","font": "minecraft:illageralt", "color": "#333333"}], ""]}
execute unless entity @s[tag=screen_died] if predicate nifeather:weather/thunder run title @s subtitle {"translate": "%1$s%3$s", "with": ["", [{"text": "Overworld","font": "minecraft:illageralt", "color": "#ffffff"}], ""]}
execute unless entity @s[tag=screen_died] if predicate nifeather:is_night run title @s subtitle {"translate": "%1$s%3$s", "with": ["", [{"text": "Overworld","font": "minecraft:illageralt", "color": "#ffffff"}], ""]}
