...
execute unless score xp_storage gm4_modules matches 19002 run data modify storage gm4:log queue append value {type:"install",module:"XP Storage"}
scoreboard players set xp_storage gm4_modules 19002
