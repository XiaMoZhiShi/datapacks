...
execute unless score tunnel_bores gm4_modules matches 19002 run data modify storage gm4:log queue append value {type:"install",module:"Tunnel Bores"}
scoreboard players set tunnel_bores gm4_modules 19002
