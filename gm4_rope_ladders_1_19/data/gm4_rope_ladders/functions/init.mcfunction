...
execute unless score rope_ladders gm4_modules matches 19002 run data modify storage gm4:log queue append value {type:"install",module:"Rope Ladders"}
scoreboard players set rope_ladders gm4_modules 19002
