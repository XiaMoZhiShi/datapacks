...
scoreboard players operation @s n3l_subrandom_temp %= #4 nife_stats
#endregion
...
#declare tag n3l_stE_attack_speed 效果：提升攻速
execute if score @s n3l_subrandom_temp matches 3 run tag @s add n3l_stE_attack_speed
#endregion
