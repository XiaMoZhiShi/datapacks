...
execute if entity @s[scores={n3l_lives=..4}, tag=n3l_curing] run function nifeather_3lives:events/player/golden_apple/stages/curing
execute if entity @s[scores={n3l_lives=5..}, tag=n3l_curing] run function nifeather_3lives:events/player/golden_apple/stages/cured
