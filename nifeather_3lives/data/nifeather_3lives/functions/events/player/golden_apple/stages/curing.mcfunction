...
execute if score @s n3l_lives matches ..9 run tellraw @s ["", {"translate": "text.hub.hint", "color": "#dddddd", "with":["\uE2B6", {"text": "你恢复了一部分身体状况（", "extra":[{"score": {"name": "@s", "objective": "n3l_lives"}}, "/5）"]}]}]