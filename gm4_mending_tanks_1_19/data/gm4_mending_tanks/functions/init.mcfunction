...
execute unless score mending_tanks gm4_modules matches 19002 run data modify storage gm4:log queue append value {type:"install",module:"Mending Tanks"}
scoreboard players set mending_tanks gm4_modules 19002
