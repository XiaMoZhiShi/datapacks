...
#尝试一次扩散
execute at @e[tag=nrr_spread_centre] run spreadplayers ~ ~ 0 35 false @s
...
execute at @s unless entity @e[tag=nrr_spread_centre, distance=..35] run tag @s add notSpawnable
