...
execute if score $nrr_c_kill_time nrr_temp matches ..200 run bossbar set nrr_display_c color red
execute unless score $nrr_c_kill_time nrr_temp matches ..200 run bossbar set nrr_display_c color white
