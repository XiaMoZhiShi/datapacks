...
execute unless score end_fishing gm4_modules matches 19002 run data modify storage gm4:log queue append value {type:"install",module:"End Fishing"}
scoreboard players set end_fishing gm4_modules 19002
