...
execute unless score beehive_inspector gm4_modules matches 19002 run data modify storage gm4:log queue append value {type:"install",module:"Beehive Inspector"}
scoreboard players set beehive_inspector gm4_modules 19002
